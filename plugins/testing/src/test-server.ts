...
import { DefaultLogger, JobQueueService, Logger, VendureConfig } from '@shoplyjs/core';
import { preBootstrapConfig, configureSessionCookies } from '@shoplyjs/core/dist/bootstrap';
...
export class TestServer {
    ...
    private async bootstrapForTesting(
        ...
        const appModule = await import('@shoplyjs/core/dist/app.module.js');
        try {
